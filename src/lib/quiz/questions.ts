...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  // ── Scoring block 2 (Q4-Q5) — hint after Q5 (4th scoring answer) ──
  {
    id: 'q4',
    type: 'choice',
  ...
  // ── Scoring block 3 (Q6-Q7) — hint after Q7 (6th scoring answer) ──
  {
    id: 'q6',
    type: 'choice',
  ...
  // ── Reflection text questions (Q8-Q9) ──
  {
    id: 'biggest-regret',
    type: 'text',
  ...
  // ── Demographics (Q10-Q15) — optional, shown on single screen ──
  {
    id: 'gender',
    type: 'select',
    q: 'You are',
