...
function EmailCaptureContent() {
  ...
  return (
    <div className="flex min-h-full flex-col items-center justify-center px-6 py-24">
      ...
      >
        <h1 className="text-center font-display text-3xl font-semibold text-foreground md:text-4xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-10 space-y-5">
          <div>
            <input
              ...
              autoComplete="email"
              className="w-full rounded-lg border border-border bg-bg-elevated py-4 px-5 text-foreground placeholder-foreground-muted/50 outline-none transition-colors focus:border-accent"
            />
            {errors.email && (
          ...
          <label className="flex items-start gap-3 text-sm text-foreground-muted">
            <input
              ...
              type="checkbox"
              className="mt-0.5 h-4 w-4 rounded border-border bg-bg-elevated text-accent"
            />
            <span>
          ...
          <button
            ...
            className="w-full rounded-lg bg-accent py-4 text-base font-medium text-bg transition-all hover:scale-[1.02] hover:bg-accent-hover disabled:opacity-50"
          >
            {isSubmitting ? "Saving..." : "Send My Report \u2192"}
          </button>
        </form>

        <div className="mt-8 flex flex-wrap items-center justify-center gap-4 text-xs text-foreground-muted">
        ...
        <div className="mt-10 text-center">
          <Link href="/quiz" className="text-xs text-foreground-muted hover:text-foreground transition-colors">
